    ...
    extend: {
      ...
      colors: {
        ...
        win: {
          ...
          "window-header": "hsl(var(--win-window-header))",
          "window-header-inactive": "hsl(var(--win-window-header-inactive))",
          "window-border": "hsl(var(--win-window-border))",
          "start-menu": "hsl(var(--win-start-menu))",
